...
class CVPPPImageDataFlow(RNGDataFlow):
	...
	def get_data(self):
		for k in range(self._size):
			...
			permut_labels = np.random.permutation(unique_labels)
			for unique_label, permut_label in zip(unique_labels, permut_labels):
				np.place(image, label==unique_label, permut_label)
